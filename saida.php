...
mysqli_query($conexao, "INSERT INTO relatorio (nome, identificacao, veiculo, placa, rua, numero, sit_escola, entrada, saida) VALUES ('$data[nome]', ' $data[identificacao]', '$data[veiculo]', '$data[placa]', '$data[rua]', '$data[numero]', '$data[sit_escola]', '$data[entrada]', '$data[saida]')");
