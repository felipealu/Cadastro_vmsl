<?php
   ...
   ;
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM entrada_saida WHERE idcadastro LIKE '%$data%' or nome LIKE '%$data%' or identificacao LIKE '%$data%' or veiculo LIKE '%$data%' or placa LIKE '%$data%' or rua LIKE '%$data%' or numero LIKE '%$data%' or sit_escola LIKE '%$data%' or entrada LIKE '%$data%' ORDER BY entrada DESC";
    }
    else
    {
