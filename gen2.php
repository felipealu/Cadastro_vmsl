<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $result = mysqli_query($conexao, "INSERT INTO cadastro (idcadastro, nome, identificacao, veiculo, placa, sit_escola) VALUES (NULL, '$nome', '$identificacao', '$veiculo', '$placa', '$sit_escola')");
